...
function handleTimeContentDrag(timeContent) {
    ...
    dragHandle.addEventListener('mousedown', (e) => {
        ...
        const ghostStartY = timeContent.getBoundingClientRect().top;
        ...
        function onMouseMove(e) {
            ...
            timeSlots.forEach((slot, index) => {
                ...
                if (e.clientY >= rect.top && e.clientY <= rect.bottom && index !== currentIndex) {
        ...
        function onMouseUp(e) {
            ...
            const targetIndex = findTargetSlotIndex(timeSlots, e.clientY);
            if (targetIndex !== -1 && targetIndex !== currentIndex) {
                const sourceHour = timeContent.dataset.hour;
                const targetHour = timeSlots[targetIndex].querySelector('.time-content').dataset.hour;
