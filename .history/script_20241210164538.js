...
function makeDraggable(element) {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        // 计算新位置
        let newX = e.clientX - freeAreaRect.left - initialX;
        let newY = e.clientY - freeAreaRect.top - initialY;
        
        // 添加边界限制
        const maxX = freeAreaRect.width - element.offsetWidth;
        const maxY = freeAreaRect.height - element.offsetHeight;
